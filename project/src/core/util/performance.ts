...
export function toArray(obj: KeyValuePair<any>): any[] {
...
export function objMap(obj: KeyValuePair<any>, cb: IObjMapCb) {
...
export function objValues<T>(obj: KeyValuePair<any>): T[] {
    const result: T[] = [];
    let k: string;
